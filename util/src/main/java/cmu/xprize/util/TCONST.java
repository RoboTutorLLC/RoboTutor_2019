...
public class TCONST {
    ...
    public static final String ZAMBIA_ASSET_PATTERN = "zambia_";
...
//    public static final String AUDIO_REF        = "audio_ref";
    ...
    // NEW_THUMBS trace me
    public enum Thumb {
        AKIRA, BPOP_NUM, GL, MN, BPOP_LTR, CX_1, CX_10, CX_100, MATH, NUMSCALE, STORY_1, STORY_2, STORY_3, STORY_4, STORY_5, SONG, STORY_NONSTORY, WRITE_LTR, WRITE_NUM, SPELLING, PICMATCH, NUMCOMPARE, COMPREHENSION, PLACEVALUE, BIGMATH, NOTHING
    }
