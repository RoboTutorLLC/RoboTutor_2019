...
import cmu.xprize.comp_inventedspelling.CInventedSpellingComponent;
...
public class TInventedSpellingComponent extends CInventedSpellingComponent implements ITutorObject, IDataSink, IPublisher, ITutorLogger, IBehaviorManager, IEventSource {
...
//    private HashMap<String,Boolean> _FeatureMap = new HashMap<>();
    ...
    public TInventedSpellingComponent(Context context) {
        super(context);
    }

    public TInventedSpellingComponent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TInventedSpellingComponent(Context context, AttributeSet attrs, int defStyleAttr) {
