...
public class CBP_Component extends FrameLayout implements IEventDispatcher, ILoadableObject {
    ...
    protected void preProcessDataSource() {
        ...
        if (gen_answer_script != null) wrk_answer_script   = new ArrayList<String[]>(Arrays.asList(gen_answer_script));
        ...
        if (gen_stimulus_script != null) wrk_stimulus_script = new ArrayList<String[]>(Arrays.asList(gen_stimulus_script));
    ...
    protected void preProcessQuestion() {
        ...
        if (gen_response_script != null) wrk_response_script = new ArrayList<String[]>(Arrays.asList(gen_response_script));
    }
